...
void personpower_RHIC(const Int_t config=0)
{
  style();
  ...
  const Int_t NP = 4;
  const Char_t *Name[NP] = {"EIC","CBM","sPHENIX","STAR"};
  const Char_t *NameC[NC] = {"default","CEplus", "CE"};

  const Double_t frac_all[NC][NP][NN][2] = {
    // default
    {{{0., 0.3}, {8.2, 0.3}, {20., 1.062}, {36, 2.67}, {40., 2.67}, {40., 2.67}},			      
     {{0., 0.4}, {5.5, 0.4}, {20., 2.448}, {30., 3.176}, {40., 4.0}, {40., 4.0}},
     {{0., 1.558}, {2., 1.558}, {10., 3.332}, {14.9, 4.0}, {40, 4.0}, {40., 4.0}},
     {{0., 4.0}, {2.,4.0}, {10., 4.0}, {20., 4.0}, {30., 4.0}, {40, 4.0}}},
    // CEplus
    {{{0., 0.3}, {8.2, 0.3}, {20., 1.062}, {36, 2.67}, {40., 2.67}, {40., 2.67}},			      
     {{0., 0.805}, {5.5, 0.805}, {20., 2.6485}, {30., 3.4185}, {40., 4.0}, {40., 4.0}},
     {{0., 1.926}, {2., 1.926}, {10., 3.407}, {14., 4.0}, {40, 4.0}, {40., 4.0}},
     {{0., 4.0}, {2.,4.0}, {10., 4.0}, {20., 4.0}, {30., 4.0}, {40, 4.0}}},
    // CE
    // {{{0., 0.3}, {8.2, 0.3}, {20., 1.062}, {36, 2.67}, {40., 2.67}, {40., 2.67}},			      
    //  {{0., 0.94}, {4.585, 0.94}, {20., 2.769}, {30., 3.358}, {40., 4.0}, {40., 4.0}},
    //  {{0., 2.0177}, {2., 2.0177}, {10., 3.58}, {13.92, 4.0}, {40, 4.0}, {40., 4.0}},
    //  {{0., 4.0}, {2.,4.0}, {10., 4.0}, {20., 4.0}, {30., 4.0}, {40, 4.0}}}
    {{{0., 0.1}, {8.2, 0.3}, {20., 1.062}, {36, 2.67}, {40., 2.67}, {40., 2.67}},			      
     {{0., 0.3}, {2.975, 0.3}, {8., 1.345}, {20., 2.769}, {30., 3.358}, {40., 4.0}},
     {{0., 1.61}, {2., 1.61}, {10., 3.606}, {13.88, 4.0}, {40, 4.0}, {40., 4.0}},
     {{0., 4.0}, {2.,4.0}, {10., 4.0}, {20., 4.0}, {30., 4.0}, {40, 4.0}}}       //  2 FTEs added by for the first two years
  };
...
//  c1->SetTopMargin(0.001);
  ...
  if(config==0) drawText(32, 2.8*sc, "CBM", 52, 0.06);
  drawText(33, 0.7*sc, "EIC", 52, 0.06);

  c1->Update();
  c1->SaveAs(Form("personpower_RHIC_%s.pdf",NameC[config]));
  c1->SaveAs(Form("personpower_RHIC_%s.png",NameC[config]));
