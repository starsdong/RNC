...
void personpower_ME(const int config=0)
{
  style();
  ...
  const Int_t NP = 3;
  const Char_t *Name[NP] = {"EIC3","JLab","EIC"};
  const Char_t *NameC[NP] = {"default","minimum"};

  const Double_t frac_all[NC][NP][NN][2] = {
    {{{0., 1.4}, {8., 1.8}, {20., 2.0}, {40, 2.6}},
     {{0., 4.0}, {8., 4.0}, {20., 4.0}, {40, 4.0}},
     {{0., 12.5}, {8., 20.5}, {20., 22.5}, {40, 22.5}}},
    {{{0., 2.1}, {8., 2.3}, {20., 2.5}, {40, 2.9}},
     {{0., 4.0}, {8., 4.0}, {20., 4.0}, {40, 4.0}},
     {{0., 10.0}, {8., 11.0}, {20., 13.0}, {40, 13.0}}},
  };
