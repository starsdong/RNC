...
void personpower_EIC(int config = 0)
{
  ...
  const Int_t NP = 4;
  const Char_t *Name[NP+1] = {"Instr-Comp","CBM-ALICE3","EIC-Other","EIC-Si"};
  const Char_t *NameC[NP] = {"default","minimum"};

  const Double_t frac_all[NC][NP][NN][2] = {
    // default
    {{{0., 2.6}, {8., 0.8}, {20., 0.8}, {40, 0.8}, {40, 0.8}},
     {{0., 2.8}, {8., 1.2}, {20., 2.4}, {40, 3.2}, {40, 3.2}},
     {{0., 5.1}, {8., 5.3}, {20., 6.3}, {40, 6.3}, {40, 6.3}},
     {{0., 8.6}, {8., 17.2}, {20., 18.8}, {40, 20.8}, {40, 20.8}}},					
    // minimum
    {{{0., 1.9}, {8., 1.5}, {20., 0.1}, {40, 1.5}, {40, 1.5}},
