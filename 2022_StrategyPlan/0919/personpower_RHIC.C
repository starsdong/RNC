...
void personpower_RHIC(const Int_t config=0)
{
  ...
  const Char_t *NameC[NP] = {"default","minimum"};

  const Double_t frac_all[NC][NP][NN][2] = {
    // default
    {{{0., 0.3}, {4.2, 0.3}, {20., 1.062}, {36, 2.67}, {40., 2.67}, {40., 2.67}},			      
     {{0., 0.5}, {3.63, 0.5}, {20., 2.238}, {30., 3.243}, {36., 4.0}, {40., 4.0}},
     {{0., 1.558}, {2., 1.558}, {10., 3.332}, {14.9, 4.0}, {40, 4.0}, {40., 4.0}},
     {{0., 4.0}, {2.,4.0}, {10., 4.0}, {20., 4.0}, {30., 4.0}, {40, 4.0}}},
    // minimum
    {{{0., 0.3}, {4.2, 0.3}, {20., 1.062}, {36, 2.67}, {40., 2.67}, {40., 2.67}},			      
     {{0., 0.46}, {3.67, 0.46}, {20., 1.99}, {30., 3.37}, {35., 4.0}, {40., 4.0}},
     {{0., 1.558}, {2., 1.558}, {10., 3.332}, {14.9, 4.0}, {40, 4.0}, {40., 4.0}},
     {{0., 4.0}, {2.,4.0}, {10., 4.0}, {20., 4.0}, {30., 4.0}, {40, 4.0}}}    
  };
