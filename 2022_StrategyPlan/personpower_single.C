...
void personpower_single(const char* name="STAR", const double *a)
{
  style();
  ...
  Double_t frac_i[NP][NN][2] = {
    {{4.0, 7.7}, {14.0, 12.2}, {30., 18.5}},				    
    {{4.0, 3.2}, {14.0, 4.0}, {30., 1.7}},
    {{4.0, 2.0}, {14.0, 2.8}, {30., 2.5}},
    {{4.0, 5.9}, {14.0, 6.6}, {30., 3.5}},
    {{4.0, 2.6}, {14.0, 4.0}, {30., 2.1}},
    {{4.0, 3.4}, {14.0, 0.5}, {30., 2.7}},
    {{4.0, 2.2}, {14.0, 2.0}, {30., 0.3}}
  };
